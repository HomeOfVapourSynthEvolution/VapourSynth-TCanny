...
void detectEdge_avx(float * blur, float * gradient, float * direction, const int width, const int height, const int stride, const int bgStride,
...
void nonMaximumSuppression_avx(const float * _direction, float * _gradient, float * blur, const int width, const int height, const int stride, const int bgStride) noexcept {
