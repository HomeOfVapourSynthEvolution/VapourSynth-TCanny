...
template<typename T> void gaussianBlurVertical_AVX(const T *, float *, float *, const float *, const unsigned, const int, const unsigned, const unsigned, const int, const float) noexcept;

template<>
void gaussianBlurVertical_AVX(const uint8_t * __srcp, float * buffer, float * blur, const float * weights, const unsigned width, const int height,
    ...
    for (int y = 0; y < height; y++) {
        ...
        gaussianBlurHorizontal_AVX(buffer, blur, weights + radius, width, radius);
...
template<>
void gaussianBlurVertical_AVX(const uint16_t * __srcp, float * buffer, float * blur, const float * weights, const unsigned width, const int height,
                              const unsigned stride, const unsigned blurStride, const int radius, const float offset) noexcept {
    const unsigned diameter = radius * 2 + 1;
...
template<>
void gaussianBlurVertical_AVX(const float * __srcp, float * buffer, float * blur, const float * weights, const unsigned width, const int height,
                              const unsigned stride, const unsigned blurStride, const int radius, const float offset) noexcept {
    const unsigned diameter = radius * 2 + 1;
